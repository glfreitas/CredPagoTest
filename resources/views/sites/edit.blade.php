        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('sites.update', $sites->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="descricao" type="text"
                                    ...
                                    value="{{ $sites->descricao }}" required autocomplete="descricao" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="url" type="url" class="form-control @error('url') is-invalid @enderror"
                                    name="url" value="{{ $sites->url }}" required autocomplete="url">
